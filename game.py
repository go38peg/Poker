...
class TexasHoldemGame:
    ...
    def play_hand(self) -> None:
        ...
        self.ui.show_message(f"Flop: {self.ui.format_cards(self.table.community_cards)}")
        ...
        self.ui.show_message(f"Turn: {self.ui.format_cards(self.table.community_cards)}")
        ...
        self.ui.show_message(f"River: {self.ui.format_cards(self.table.community_cards)}")
